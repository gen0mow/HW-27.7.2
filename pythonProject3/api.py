...
class PetFriends:
    ...
    def get_api_key(self, email: str, password: str) -> json:
        ...
        в формате JSON с уникальным ключом пользователя, найденного по указанным email и password"""
        headers= {
            'email': email,
            'password': password
        }
    ...
    def get_list_of_pets(self, auth_key: json, filter: str = "") -> json:
        ...
        момент фильтр может иметь либо пустое значение - получить список всех питомцев,
